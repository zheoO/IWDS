 ...
 *  @brief 本地log文件管理类
 */
@interface IWDSLoggerManager : NSObject
...
/**
 *  @brief 设置log缓存的绝对目录,默认Library/Caches/IWDSLogger
 */
 ...
 *  @brief 唯一初始化方法
 *
 *  @return IWDSLoggerManager实例
 */
+ (IWDSLoggerManager *)sharedInstance;

/**
 *  @brief 配置log存储路径和名称
 *
 *  @param cacheDirectory 缓存目录，nil则使用Library/Caches/IWDSLogger
